...
app.get("/jokes/:id",(req,res)=>
  {
    ...
    if(id && id<=jokes.length && id >0)
    {
      res.send(jokes[id-1]);
    }
    else
    {
      res.send({"Erorr":"Incorrect ID"});
    }
...
app.get("/filter",(req,res)=>
  {
    ...
    if(typeof type === "string" )
    {
      ...
      jokes.forEach((i)=>{
          if (i.jokeType.toLowerCase() === type.toLowerCase())
          {
            arr.push(i);
...
app.post("/jokes",(req,res)=>
  {
    const newI ={jokeText:req.body.text ,jokeType:req.body.type,id:jokes.length+1}
    ...
    {
      res.json("You must fill in the text and type fields.");
    }
...
app.put("/jokes/:id",(req,res)=>
  {
    ...
    if(id && id<=jokes.length && id >0)
    {
      const newI ={jokeText:req.body.text ,jokeType:req.body.type,id:id}

      res.send(jokes[id-1] = newI);
    }
    else
    {
      res.send({"Erorr":"Incorrect ID"});
...
app.delete("/all",(req,res)=>

  {
    if(req.query.key===masterKey)
    {
      ...
      res.status(404).json("Incorrect key")
    }
  }
);
